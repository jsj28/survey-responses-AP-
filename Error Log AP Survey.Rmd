...
## Upward Mobility
Education of Children to Parent’s education - Breakdown by male and female (Comparison with PLFS)
...
To be done later - AP youth is not growing up in a cushy environment - Asset ownership
...
caste_plot <- ggplot(caste, aes(x= `Household Caste Category`, y= Proportions, fill = `Household Caste Category`)) +
  ...
  labs(x="",y="Percentage", subtitle = "Government Caste Category of households") + newtheme
...
religion_plot <- ggplot(religion, aes(x= `Religion of Household`, y= Proportions, fill = `Religion of Household`)) +
  ...
  scale_fill_brewer(palette="YlGnBu") +
  labs(x="",y="Percentage", subtitle = "Religion of Household") + newtheme
...
Y_G_186_plot <- ggplot(Y_G_186, aes(x= Response, y= Proportions, fill = Response)) +
  geom_bar(stat="identity", width= 0.5, show.legend = FALSE) + 
  geom_text (aes(label = Proportions), position = position_dodge(0.1), vjust = -1) +
  scale_y_continuous(limits = c(0,80)) +
  scale_x_discrete(labels = function(`Response`) str_wrap(`Response`, width = 10)) +
  scale_fill_brewer(palette="YlGnBu") +
  labs(x="",y="Percentage", subtitle = "Do you think your economic fortunes will be better or worse than your parents?") + newtheme
...
Y_G_187_plot <- ggplot(Y_G_187, aes(x= Response, y= Proportions, fill = Response)) +
  ...
  scale_x_discrete(labels = function(`Response`) str_wrap(`Response`, width = 10)) +
  scale_fill_brewer(palette="YlGnBu") +
  labs(x="",y="Percentage", subtitle = "In the past 5 years, compared to other states in India, do you believe citizens of Andhra Pradesh have done better or worse?") + newtheme
...
Y_G_188_plot <- ggplot(Y_G_188, aes(x= Response, y= Proportions, fill = Response)) +
  ...
  scale_x_discrete(labels = function(`Response`) str_wrap(`Response`, width = 10)) +
  scale_fill_brewer(palette="YlGnBu") +
  labs(x="",y="Percentage", subtitle = "Do you believe the amount given in cash schemes should be more or less?") + newtheme
...
Y_G_189_plot <- ggplot(Y_G_189, aes(x= Response, y= Proportions, fill = Response)) +
  ...
  scale_x_discrete(labels = function(`Response`) str_wrap(`Response`, width = 10)) +
  scale_fill_brewer(palette="YlGnBu") +
  labs(x="",y="Percentage", subtitle = "Do you believe democracy in India is getting stronger or weaker?") + newtheme
...
bp <- barplot(100*prop.table(t$Freq), names.arg = wrap.labels(t$Var1, 20), ylim = c(0,50), border = NA, col = "coral2", main = "Structure of Employment Among Youth", xlab = "Primary Activity", ylab = "Percentage of Labour Force", cex.names = 0.75)
...
bp <- barplot(100*prop.table(t$Freq), names.arg = wrap.labels(t$Var1, 20), ylim = c(0,50), border = NA, col = "coral2", main = "Structure of Employment Among Adults (30+)", xlab = "Primary Activity", ylab = "Percentage of Labour Force", cex.names = 0.75)
text(bp, 100*prop.table(t$Freq), round(100*prop.table(t$Freq)), pos = 3)
...
bp <- barplot(100*prop.table(t$Freq), names.arg = wrap.labels(t$Var1, 20), ylim = c(0,50), border = NA, col = "coral2", main = "Structure of Employment Among Youth (19-24)", xlab = "Primary Activity", ylab = "Percentage of Labour Force", cex.names = 0.75)
text(bp, 100*prop.table(t$Freq), round(100*prop.table(t$Freq)), pos = 3)
...
bp <- barplot(100*prop.table(t$Freq), names.arg = wrap.labels(t$Var1, 20), ylim = c(0,50), border = NA, col = "dodgerblue", main = "Structure of Employment Among Youth (25-29)", xlab = "Primary Activity", ylab = "Percentage of Labour Force", cex.names = 0.75)
text(bp, 100*prop.table(t$Freq), round(100*prop.table(t$Freq)), pos = 3)
...
bp <- barplot(t(100*t[,c(2:3)]), beside = T, names.arg = wrap.labels(t$Var1, 20), ylim = c(0,50), border = "white", col = c("dodgerblue","coral2"), main = "Structure of Employment Among Youth (by Gender)", xlab = "Primary Activity", ylab = "Percentage of Labour Force", cex.names = 0.8)
...
```{r, echo=F, message=FALSE, warning=F, fig.width = 10, fig.height=6}
...
bp <- barplot(v, col = c("navyblue", "dodgerblue3", "dodgerblue", "skyblue2"), border = NA, las = 1, ylim = c(0,50), main = "Proportion of Respondents Interested in taking Skilling Courses", names.arg = c('Overall', 'Student', 'Employed', 'Unemployed'), xlab = "Category", ylab = "Percentage within Category")
text(bp, v, round(v, 1), pos = 3)
